...
Only the **latest released version** of `GroupDocs.Comparison.Mcp` (NuGet / GHCR / Docker Hub)
...
- Use GitHub's [private vulnerability reporting](https://github.com/groupdocs-comparison/GroupDocs.Comparison.Mcp/security/advisories/new)
...
- Vulnerabilities in the underlying `GroupDocs.Comparison` engine (a closed-source NuGet
