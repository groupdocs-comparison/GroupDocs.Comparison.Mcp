...
Thanks for your interest in improving the GroupDocs.Comparison MCP server.
...
`.vscode/mcp.json` contains a `groupdocs-comparison-dev` entry that runs the server from
...
Use the [issue templates](https://github.com/groupdocs-comparison/GroupDocs.Comparison.Mcp/issues/new/choose).
