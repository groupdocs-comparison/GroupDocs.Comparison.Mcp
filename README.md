...
```bash
dnx GroupDocs.Comparison.Mcp@26.8.0 --yes
```
...
> `"GroupDocs.Comparison.Mcp@26.8.0"` in `args`. Pinning is recommended for
...
> `"GroupDocs.Comparison.Mcp@26.8.0"` to lock to a specific release.
